...
class ToastManager {
    ...
    createToast(message, type) {
        ...
        toast.className = 'bg-slate-800 border border-slate-700 rounded-lg shadow-lg p-4 min-w-[300px] max-w-md transform transition-all duration-300';
            ...
            <div class="flex items-start">
                ...
                <div class="ml-3 flex-1">
                    ...
                    <div class="mt-2 h-1 bg-slate-700 rounded-full overflow-hidden">
                        <div class="toast-progress h-full bg-${type === 'success' ? 'green' : type === 'error' ? 'red' : type === 'warning' ? 'yellow' : 'blue'}-500 transition-all duration-[5000ms] ease-linear" style="width: 100%"></div>
                    </div>
                </div>
                <div class="ml-4 flex-shrink-0">
                    <button onclick="toastManager.dismiss(this.closest('.bg-slate-800'))" class="inline-flex text-slate-400 hover:text-slate-300 focus:outline-none">
